...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    if (!isAdmin) return;
    axios.get("https://hospital-management-89cv.onrender.com/all-users")
      .then(res => {
  ...
  const deleteUser = (id) => {
    if (window.confirm("Delete this customer?")) {
      axios.delete(`https://hospital-management-89cv.onrender.com/delete/${id}`)
      ...
      <div className={styles.dashboardCard}>
        <div className={styles.tableHeader}>
          ...
          <button
            ...
            onClick={() => window.open("https://hospital-management-89cv.onrender.com/download-all")}
          >
            ⬇ Download All
          </button>
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => window.open(`https://hospital-management-89cv.onrender.com/download-user/${user.id}`)}
                      >⬇</button>
                      <button
