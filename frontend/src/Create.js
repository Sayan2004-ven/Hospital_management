...
export default function Create() {
  ...
  const sendOTP = async () => {
    ...
    setOtpLoading(true);
    try {
      const res = await axios.post(" https://hospital-backend-tpge.onrender.com/send-otp", { phone: form.phone });
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      const verify = await axios.post(" https://hospital-backend-tpge.onrender.com/verify-otp", {
      ...
      const res = await axios.post(" https://hospital-backend-tpge.onrender.com/create", form);
      if (res.data.success) {
